 ...
 */
final class Version20211031164855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD subscription_id INT DEFAULT NULL, ADD subscription_expires DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP subscription_id, DROP subscription_expires');
    }
}
